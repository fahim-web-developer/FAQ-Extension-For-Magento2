...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    const XML_PATH_RELATED_PRODUCT_DISPLAY =
        'fahim_faq/related_setting/related_products/enabled';
    /**
     *
     */
    const XML_PATH_RELATED_PRODUCT_NUMBER =
        'fahim_faq/related_setting/related_products/number_of_products';
    /**
     *
     */
    const XML_PATH_RELATED_SHOW_CART =
        'fahim_faq/related_setting/related_products/show_addtocart';
    /**
     *
     */
    const XML_PATH_RELATED_SHOW_WISHLIST =
        'fahim_faq/related_setting/related_products/show_whishlist_icon';
    /**
     *
     */
    const XML_PATH_RELATED_SHOW_COMPARE =
        'fahim_faq/related_setting/related_products/show_compare_icon';
    ...
    public function initProductLayout(
        ...
        $faqListLayout = $this->getFaqList(
            'fahim/general/' .
            $layoutId
        );
        $pageConfig = $resultPage->getConfig();
        $pageConfig->setPageLayout($faqListLayout);
        return $this;
    }
