<?php
namespace Fahim\Faq\Controller;
...
use Fahim\Faq\Model\FaqFactory;
use Fahim\Faq\Model\FaqcatFactory;
    ...
    public function match(\Magento\Framework\App\RequestInterface $request)
    {
        if (!$this->dispatched) {
            ...
            $this->eventManager->dispatch(
                'Fahim_faq_controller_router_match_before',
